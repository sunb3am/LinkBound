...
4. **Controlled activity pilot:** Choose a conservative per-account budget and
...
uncertain-action stops. The unread and attachment checks remain part of Phase D.
The review provides no basis to claim the VM is a laptop or that browser
automation is undetectable.

## Implementation in the risk-controls branch
